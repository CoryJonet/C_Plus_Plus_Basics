...
/**
 * Copy Constructor: Copies a student's info to this student's info
 *
...
/**
 * Destructor: Destructs this student
 */
...
/**
 * Assignment Operator: Used in the form of <student1> = <student2> where <stude * nt1> gets the info from <student2>
 *
 * @param S The student's info to copy to this student
 * @return This student with info from S student
 */
