...
class SortedList {
  ...
  public:
    ...
    SortedList & operator=(const SortedList &S);
    // Assignment
  ...
  private:
    ...
    static void      freeList (Listnode *L); //freeList auxiliary function 
    static Listnode *copyList (Listnode *L); //copyList auxiliary function
};
